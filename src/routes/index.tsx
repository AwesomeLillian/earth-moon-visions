...
export const Route = createFileRoute("/")({
  ...
  head: () => ({
    ...
    links: [{ rel: "canonical", href: "/"[STRIPPED 107 bytes]"0 0 24 24" fill="currentColor" aria-hidden="true" className={className}>
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main>
        <section className="surface-glow relative overflow-hidden border-b border-border/60">
          <div className="mx-auto grid max-w- gap-12 px-5 py-16 md:min-h- md:grid-cols-[minmax(0,0.8fr)_minmax(0,1.2fr)] md:items-center md:gap-10 md:py-20 lg:gap-16 lg:px-8 lg:py-24">
      ...
      <footer className="border-t border-border/60 bg-card/40"><div className="mx-auto flex max-w-6xl flex-col gap-6 px-5 py-10 md:flex-row md:items-center md:justify-between"><div className="h-20 w- max-w-full overflow-hidden"><img src={logo.url} alt="Moon And Earth Trading logo" className="h-full w-full object-contain object-left" /></div><div className="text-sm text-muted-foreground"><p>{ADDRESS}</p><p className="mt-1">© 2009 Moon And Earth Trading And Projects 11cc. All rights reserved.</p></div></div></footer>
    </div>
  );
}
