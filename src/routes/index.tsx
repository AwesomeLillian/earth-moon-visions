...
const img = (file: string) => ({ url: `/images/${file}` });

const logo = img("logo-dark.jpg");
const chamber = img("chamber.jpg");
const trenching = img("trenching.jpg");
const compaction = img("compaction.jpg");
const serverBox = img("server-box.jpg");
const tonerHp = img("toner-hp.png");
const tonerSamsung = img("toner-samsung.png");
const embroidery = img("embroidery.jpg");
const paving = img("paving.jpg");
const patchPanels = img("patch-panels.jpg");
const rackSwitch = img("rack-switch.jpg");
const dataPoint = img("data-point.jpg");
const cyberpunkFiber = img("cyberpunk-fiber.jpg");
const serverRackFull = img("server-rack-full.jpg");
const pavingRoad = img("paving-road.jpg");
const peripherals = img("peripherals.jpg");
const mediaPrinting = img("media-printing.jpg");
