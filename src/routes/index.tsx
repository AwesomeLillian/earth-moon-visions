  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main>
        ...
        <section id="contact" className="w-full border-t border-border/60"><div className="mx-auto w-full max-w- px-5 py-16 lg:px-10 xl:px-16"><h2 className="text-3xl font-bold md:text-4xl">VISIT OR CONTACT US</h2><div className="mt-8 grid gap-8 lg:grid-cols-[0.9fr_1.1fr]"><div className="space-y-5"><div className="flex gap-3 rounded-2xl border border-border/70 bg-card p-5"><MapPin className="mt-0.5 h-5 w-5 shrink-0 text-primary" /><div><p className="font-semibold">Office</p><p className="mt-1 text-sm text-muted-foreground">{ADDRESS}</p><a href={MAP_LINK} target="_blank" rel="noreferrer" className="mt-2 inline-flex items-center gap-1 text-sm font-medium text-primary hover:underline">Open in Google Maps<ArrowUpRight className="h-3.5 w-3.5" /></a></div></div><div className="overflow-hidden rounded-2xl border border-border/70"><iframe title="Map" src={MAP_EMBED} loading="lazy" referrerPolicy="no-referrer-when-downgrade" className="h- md:h- w-full border-0" /></div></div><ContactForm /></div></section>
      </main>
