    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main>
        ...
        <section id="contact" className="w-full border-t border-border/60 bg-card/40">
          <div className="mx-auto w-full max-w- px-5 py-16 lg:px-10 xl:px-16">
            ...
            <div className="mt-8 grid gap-8 lg:grid-cols-[0.9fr_1.1fr]">
              <div className="space-y-5">
                ...
                <div className="overflow-hidden rounded-2xl border border-border/70">
                  <iframe title="Map" src={MAP_EMBED} loading="lazy" referrerPolicy="no-referrer-when-downgrade" className="h- md:h- w-full border-0" />
                </div>
              </div>
              <ContactForm />
            </div>
